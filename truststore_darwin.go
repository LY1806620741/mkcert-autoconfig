...
func (m *mkcert) installPlatform() bool {
	...
	fatalIfErr(err, i18nText.scan80,
	)
	...
	fatalIfErr(err, i18nText.scan84,
	)
	err = ioutil.WriteFile(plistFile.Name(), plistData, 0600)
	fatalIfErr(err, i18nText.scan85,
	)
