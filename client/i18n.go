...
`,
	...
	i18nText.scan110 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan110",
			Other: `failed duplicating context: %v`,
		},
	})
	...
	i18nText.scan97 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID: "scan97",
			Other: `Prompt failed %v
`,
		},
	})
	...
	i18nText.scan104 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan104",
			Other: `invalid PEM data`,
		},
	})
...
`,
	...
	i18nText.scan98 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan98",
			Other: `选择错误`,
		},
	...
	i18nText.scan103 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan103",
			Other: `mkcert-rootCA`,
		},
	...
	i18nText.scan102 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan102",
			Other: `无法读取文件内容：`,
		},
...
`,
	...
	i18nText.scan108 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan108",
			Other: `failed adding cert: %v`,
		},
	})
	...
	i18nText.scan106 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan106",
			Other: `failed to open windows root store: %v`,
		},
	})
...
`,
	...
	i18nText.scan111 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan111",
			Other: `failed deleting certificate: %v`,
		},
	})
	...
	i18nText.scan107 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan107",
			Other: `failed to close windows root store: %v`,
		},
	})
	...
	i18nText.scan99 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan99",
			Other: `无法打开文件：`,
		},
	...
	i18nText.scan105 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan105",
			Other: `no certs found`,
		},
	})
	...
	i18nText.scan109 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan109",
			Other: `failed enumerating certs: %v`,
		},
	})
	...
	i18nText.scan101 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan101",
			Other: `无法移动到指定位置：`,
		},
...
`,
	...
	i18nText.scan100 = localizer.MustLocalize(&i18n.LocalizeConfig{
		DefaultMessage: &i18n.Message{
			ID:    "scan100",
			Other: `无法获取文件信息：`,
		},
